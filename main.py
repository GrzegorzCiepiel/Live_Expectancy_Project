...
plt.figure()
plt.hist(high_gdp['Life_exp'], alpha = 0.5, label = "High GDP", density=True)
plt.hist(low_gdp['Life_exp'], alpha = 0.5, label = "Low GDP", density=True)
plt.legend()
plt.savefig('LiveexpvsGDP.png')
plt.show()
plt.clf()